...
class SMTP
{
    ...
    private $port = 25;
    private $secure = null; // null, 'ssl', or 'tls'
    private $auth = true; // true if authorization required
    private $user;
    private $pass;
    ...
    public function __construct($config)
    {
        ...
        $this->secure = !empty($config['secure']) ? $config['secure'] : $this->secure;
        $this->auth = !empty($config['auth']) ? $config['auth'] : $this->auth;
